...
Documentation applied it to prose, which is a different job: you cannot compile a sentence or unit-test a paragraph. Keeping a large body of text true across versions and products is dull work, and it's already been solved — just not by anyone writing documentation from scratch.
